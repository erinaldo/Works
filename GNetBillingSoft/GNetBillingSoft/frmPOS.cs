...
namespace GNetBillingSoft.Transactions
{
    ...
    public partial class frmPOS : Form
    {
        ...
        public frmPOS()
        {
            ...
            cmbcustomer.LostFocus += new EventHandler(cmbcustomer_LostFocus);
            AddInvoice();
        ...
        void cmbcustomer_LostFocus(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Validation())
                {
                   ...
                   // sales.additionaldiscount = Convert.ToDouble((txtadddiscount.Text != "") ? txtadddiscount.Text : "0");
                    ...
                    try
                    {
                        clsServerOperation.Delete(sales.salesinvoice);
                    }
                    catch (Exception)
                    {
                    }
...
//private extern static bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, int uFlags);
        ...
        private void frmPOS_Load(object sender, EventArgs e)
        {
           ...
           // KeyPadStart();
            ...
            //this.MdiParent.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            //this.MdiParent.MainMenuStrip.Visible = false;
